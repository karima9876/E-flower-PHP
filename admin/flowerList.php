        ...
        <div class="row">
            ...
            <table style="table-layout: fixed;width: 100%;" class="table table-condensed">
                ...
                <tr>
                    ...
                    <!-- <th><img width="80px" src="download.jpg"/> </th> -->
                   <td style="word-wrap: break-word;"><img width="100px" src="<?php echo $row['image'] ?>"/> </td>
                    ...
                    <td>
                        <a href="flowerEdit.php?id=<?php echo $row['id']; ?>">Edit /</a>
                        <a onclick="return confirm('Are You Sure to Delete?')"href="flowerList.php?id=<?php echo $row['id']; ?>">Delete</a>
                    </td>
                  </tr>
                <?php  ++$i; } ?>
            </table>
