            ...
            <table style="table-layout: fixed;width: 100%;" class="table table-condensed">
                ...
                <tr>
                    <!-- <td style="word-wrap: break-word;"><?php echo $row['id']; ?></td> -->
                      <td style="word-wrap: break-word;"><?php echo $i; ?></td>
                    <td style="word-wrap: break-word;"><?php echo $row['name']; ?></td>
                    <td style="word-wrap: break-word;"><?php echo $row['phone']; ?></td>
                    <td style="word-wrap: break-word;"><?php echo $row['description']; ?></td>
                    <td style="word-wrap: break-word;"><?php echo $row['transaction_id']; ?></td>
                    <td style="word-wrap: break-word;"><?php echo $row['total_amount']; ?></td>
                    <td style="word-wrap: break-word;"><?php echo $row['address']; ?></td>
                    <td style="word-wrap: break-word;"><?php echo $row['delivery_status']; ?></td>
                    
                    
                    <td>
                        <a href="purchaseEdit.php?id=<?php echo $row['id']; ?>">Edit /</a>
                        <a onclick="return confirm('Are You Sure to Delete?')"href="purchaseList.php?id=<?php echo $row['id']; ?>">Delete</a>
                    </td>
                  </tr>
                <?php  ++$i; } ?>
            </table>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © My Website <?php echo date('Y')?></span>
            </div>
          </div>
        </footer>
      </div>
